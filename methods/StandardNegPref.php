...
/**
 * Description of StandardNegPref
 * This method implements simple negative user preference model based on visible & ignored behavior. Method removes all objects, which were presented to the user for too many times.
