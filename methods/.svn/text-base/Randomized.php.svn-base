 ...
 * method implements all expressionType interfaces (ObjectRating,ObjectSimilarity,UserSimilarity,Collaborative)
 * @author peska
 */
class Randomized extends Standard implements ObjectRating,ObjectSimilarity,UserSimilarity,Collaborative{
    //put your code here
