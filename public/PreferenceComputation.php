...
/**
 * Description of PreferenceComputation
 * Computes histogram-based cluster model for preference based on feedback values.
 * for each bin, the method computes sum of purchases divided by sum of all feedback occurences
 *
 * @author peska
 */
